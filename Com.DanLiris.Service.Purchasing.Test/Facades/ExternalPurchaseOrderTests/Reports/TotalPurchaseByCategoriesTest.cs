...
namespace Com.DanLiris.Service.Purchasing.Test.Facades.ExternalPurchaseOrderTests.Reports
{
	...
	public class TotalPurchaseByCategoriesTest
    {
		...
		[Fact]
		public async void Should_Success_Get_Report_Total_Purchase_By_Categories_Data_Excel_Null_Parameter()
		{
			ExternalPurchaseOrder externalPurchaseOrder = await DataUtil.GetNewData("unit-test");
			await FacadeEPO.Create(externalPurchaseOrder, "unit-test", 7);
		...
		[Fact]
		public async void Should_Success_Get_Report_Total_Purchase_By_Categories_Null_Data_Excel()
		{
