...
{
    public interface IGarmentUnitDeliveryOrder
    {
        Tuple<List<GarmentUnitDeliveryOrder>, int, Dictionary<string, string>> Read(int Page = 1, int Size = 25, string Order = "{}", string Keyword = null, string Filter = "{}");
